...
import com.aigo.italyapp.util.CompareSizesByArea
import com.aigo.italyapp.view.AutoFitTextureView
...
class DlibActivity : AppCompatActivity(), View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback {

    private val surfaceTextureListener = object : TextureView.SurfaceTextureListener {

        @RequiresApi(Build.VERSION_CODES.M)
        override fun onSurfaceTextureAvailable(texture: SurfaceTexture, width: Int, height: Int) {
            dlibView.setSizeImage(height, width)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        this.dlibView = findViewById(R.id.dlibView)

//        startBackgroundThread()
//
//        this.faceObj = backgroundHandler?.let { FaceObj(it, dlibView) }!!

    }

    private var REQUEST_CAMERA_PERMISSION = 100
    private lateinit var faceObj : FaceObj
    ...
    private lateinit var dlibView: DlibView
    ...
    object : CameraDevice.StateCallback() {
        ...
        override fun onOpened(cameraDevice: CameraDevice) {
            ...
            this@DlibActivity.cameraDevice = cameraDevice
        ...
        override fun onDisconnected(cameraDevice: CameraDevice) {
            cameraOpenCloseLock.release()
            cameraDevice.close()
            this@DlibActivity.cameraDevice = null
        }

        override fun onError(cameraDevice: CameraDevice, error: Int) {
            onDisconnected(cameraDevice)
            this@DlibActivity?.finish()
        }
...
//        backgroundHandler?.post(ImageSaver(it.acquireNextImage(), file))
    ...
    override fun onResume() {
        ...
        if (textureView.isAvailable) {
            ...
            dlibView.setSizeImage(textureView.height, textureView.width)
...
//                }
            imageReader?.setOnImageAvailableListener(faceObj, backgroundHandler)
...
//                    this.showToast("Saved: $file")
    ...
    companion object {
         ...
         */
        private val MAX_PREVIEW_WIDTH = 2560

        /**
         * Max preview height that is guaranteed by Camera2 API
         */
        private val MAX_PREVIEW_HEIGHT = 1800
